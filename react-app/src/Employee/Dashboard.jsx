...
>
  <Box sx={{ p: 3 }}>
    ...
    >
      ...
      <IconButton onClick={() => setActiveProjectDrawerOpen(false)}>
        <CloseIcon />
      </IconButton>
    </Box>
    <Divider sx={{ mb: 3 }} />
    ...
    {currentUserProjects.filter((project) => project.Projects.Status === "Work In Process").length === 0 ? (
      ...
      <TableContainer component={Paper}>
        <Table sx={{ minWidth: 650 }} aria-label="active project table">
          <TableHead>
            ...
            {currentUserProjects
              ...
              .map((project) => (
                ...
                >
                  ...
                  <TableCell>
                    {new Date(project.Projects.Start_Date).toLocaleDateString()}
                  </TableCell>
                  <TableCell>
                    {new Date(project.Projects.End_Date).toLocaleDateString()}
                  </TableCell>
                  <TableCell>
                    <Box
                      sx={{
