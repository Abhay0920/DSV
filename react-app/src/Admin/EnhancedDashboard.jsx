...
export default function EnhancedDashboard() {
  ...
  useEffect(() => {
    ...
    setTotalopen(statusCount.Pending);
    setTotalWorking(statusCount["In Progress"]);
  ...
  useEffect(() => {
    ...
    taksData?.forEach((task) => {
      ...
      else if (task.Status === "Pending") grouped[taskYear].open++;
      else if (task.Status === "In Progress") grouped[taskYear].working++;
